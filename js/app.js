...
const TONE_DESCRIPTIONS =   NO_EMDASH_RULE = `Never use em dashes (—) or en dashes (–) in any content. Use commas, periods, or rewrite sentences instead. Never use the word "delve", "crucial", "pivotal", or phrases like "it is worth noting" or "in today's landscape".`;
